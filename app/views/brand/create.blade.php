...
<form class="form-horizontal" method="POST" action="{{asset('marca')}}">
<div class="col-lg-12">
    <div class="box dark">
        <header>
        ...
        <div id="div-1" class="accordion-body collapse in body">            
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text"  placeholder="Ingrese el nombre de la marca" name='name' class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Manofacturador</label>
                    <div class="col-lg-8">
                        <input type="text"  placeholder="Manofacturador" name="manofacturer" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Proveedor</label>
                    <div class="col-lg-8">
                        <input type="text"  placeholder="Proveedor de la marca" name="provider" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Descripci&oacute;n</label>
                    <div class="col-lg-8">
                        <input type="text"  placeholder="Descripci&oacute;n adicional de la marca" name="description" class="form-control" />
                    </div>
                </div>                
