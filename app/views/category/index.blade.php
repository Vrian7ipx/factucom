        ...
        <div class="box primary">            
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="categorias-datatable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <a class="btn btn-primary btn-xs" href="{{asset('categoria/'.$category->public_id)}}">
