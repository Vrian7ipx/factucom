...
<div class="inner">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Editar Categor&iacute;a</h3>
        </div>
    </div>
<form class="form-horizontal" method="POST" action="{{asset('categoria/editar/'.$category->public_id)}}">
<div class="col-lg-12">
    <div class="box dark">
        <header>
        ...
        <div id="div-1" class="accordion-body collapse in body">            
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$category->name}}" placeholder="Ingrese nombre de la categor&iacute;a" name='name' class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Descripci&oacute;n</label>
                    <div class="col-lg-8">
                        <input type="text" value="{{$category->description}}" placeholder="Breve descripci&oacute;n" name="description" class="form-control" />
                    </div>
                </div>                                
        </div>
