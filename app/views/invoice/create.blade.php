...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
               ...
               <div class="form-group col-lg-5">
                ...
                <div class="form-group col-lg-5">
                    <label>Fecha</label>
                    <input type="text" name="deadline" class="form-control" data-date-format="dd/mm/yyyy" id="date" />
                      <p class="help-block">Example block-level help text here.</p>
                </div>
                
                <table id="tableb" cellpadding="0" cellspacing="0" > 
        <tbody>
            <tr>
        ...
        <tr class="new_row" id="new_row1">
          ...
          <td><input id="notes1" class="form-control notes" name="productos[0][name]"></td>    
    ...
    <div class="col-md-2">
      <label>Total</label>
      <br>
      <label>Descuento</label> BS<input class="uniform" type="radio" name="optionsRadios" value="option1" checked="checked" />
...
<div class="col-lg-12">
	...
	<div class="col-lg-2"> <button type="button" class="btn btn-info btn-circle btn-lg" onclick="preview()"><i class="icon-eye-open"></i></div>
